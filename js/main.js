...
contenedorProductos.addEventListener("click", (e) => {
  ...
  if (target.classList.contains("producto-agregar")) {
    ...
    if (producto && producto.carrusel) {
      ...
      console.error(
        "El producto no tiene la propiedad 'carrusel' definida o es indefinido."
      );
    }
  }
});
...
function cargarCarrusel(productoId, productoTitulo) {
  ...
  if (producto && producto.carrusel) {
    ...
    console.error(
      "No se pudo cargar el carrusel para el producto con id:",
      productoId
    );
  }
}
      ...
      producto.titulo
            ...
            <div class="producto-detalles">
                ...
                <p class="producto-precio ${
                  producto.stock === "agotado" ? "agotado" : ""
                }">
  $${producto.precio.toLocaleString("es-CL")}
</p>
<p class="producto-stock ${
      producto.stock === "disponible" ? "disponible" : "agotado"
    }">
  ${producto.stock}
</p>

                <button class="producto-agregar" data-bs-toggle="modal" data-bs-target="#exampleModal" data-producto-id="${
                  producto.id
                }">Mostrar Más</button>
            </div>
        `;
